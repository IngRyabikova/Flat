...
int main()
{
  ...
  //  string PageCategory = "";
    ...
    Button[3] = {Button[0].picture, 750,0, "Ïëàíèðîâêè", "Plan", 200, 60 };
    ...
    int y_Strelka = 0;
     ...
     HDC Plan =  txLoadImage("Êàðòèíêè/Êíîïêè/Ïëàí.bmp");
    int x_Plan = 0;
    int y_Plan = 0;
    ...
    int x_Plan_ = 0;
    int y_Plan_ = 0;
    HDC Plan_ = txLoadImage("Êàðòèíêè/Ïëàíû/Ïëàí_1.bmp");

    HDC reklama = txLoadImage("Êàðòèíêè/Ìåíþ/Ðåêëàìà 1.bmp");
    int x_reklama = 0;
    int y_reklama = 0;
    ...
    variants[7] = {1100, 450, 150, 70, txLoadImage("Êàðòèíêè/Äèâàíû/Divan2.bmp"), false, "Sofa"};
    ...
    Picture Plans[25];
    Plans[0] = {1113, 150, 170, 93, txLoadImage("Êàðòèíêè/Ïëàíû/Ïëàí_1_ìèíè.bmp"), false, "Plan"};
    Plans[1] = {1115, 350, 200, 110, txLoadImage("Êàðòèíêè/Ïëàíû/Ïëàí_2_ìèíè.bmp"), false, "Plan"};
   // Plans[2] = {1100, 550, 192, 212, txLoadImage("Êàðòèíêè/Êðîâàòè/Ïëàí_3_ìèíè.bmp"), false, "Bed"};
    //Picture Plans2[2500];
